...
def qchem_h2o_sp_output(testing_data_path: Path) -> str:
...
@pytest.fixture(scope="session")
def parsed_qchem_h2o_sp_data(qchem_h2o_sp_output: str) -> CalculationResult:
    """Fixture that provides the fully parsed CalculationResult object."""
    return parse_qchem_sp(qchem_h2o_sp_output)
